...
@Sources({ "file:conf/empirical_ranker_autoweka.properties" })
public interface EmpiricalRankerAutoWEKAExperimenterConfig extends IMultiClassClassificationExperimentConfig, IDatabaseConfig {
